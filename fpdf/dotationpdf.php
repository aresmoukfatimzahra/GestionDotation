...
// Header starts /// 
$pdf->Cell($width_cell[0],10,'Id dotation',1,0,'C',true); // First header column 
$pdf->Cell($width_cell[1],10,'Solde',1,0,'C',true); // Second header column
$pdf->Cell($width_cell[2],10,'Date dotation',1,0,'C',true); // Third header column 
$pdf->Cell($width_cell[3],10,'Observation',1,0,'C',true); // Fourth header column
$pdf->Cell($width_cell[4],10,'Numero de puce ',1,1,'C',true); // Third header column 
